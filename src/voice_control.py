...
class voice_control:
    """
    the voice_control class is a node that controls baxter motions through
    speech recognition. There are seven joints per arm:
    ...
    The voice command structure is as follows:

    arm ('left' or 'right') to specify arm
    joint name (from list above) to specify joint
    'increase' to increase the joint angle
    'decrease' to decrease
    'joint' to print the current joint angles to the screen
    """
